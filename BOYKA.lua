...
os.execute('wget https://raw.githubusercontent.com/TEAMMERO/MERO1/master/BOYKA.lua')
...
🔰↬[Information](t.me/MERO_01)

👮‍♂️↬[DEVELOPER](t.me/FEEEM)

🔖↬[The way his inauguration](https://t.me/MERO170/15)

📌↬[To talk to us](t.me/OMER45Bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAMMERO/Files_Boyka/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAMMERO/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس ميرو\n") 
end
return false
end
