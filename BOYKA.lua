...
os.execute('wget https://raw.githubusercontent.com/BOTMERO/MERO1/master/BOYKA.lua')
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BOTMERO/Files_Boyka/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/BOTMERO/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
